...
<script>
    ...
    import {params,callback,url,ERR_OK} from "api/getRecommend"
    ...
    export default {
      ...
      methods:{
        _getRecommend(){
          this.$http.jsonp(url,{params:params,"jsonp":callback}).then((res)=>{
        ...
        _getDissList(){
          axios.get('http://120.78.90.148:8080/api/getDissList').then((res)=>{
